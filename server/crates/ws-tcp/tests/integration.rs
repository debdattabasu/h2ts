...
use ws_tcp::{
    accept, bridge, bridge_with, control_channel, serve_h2, BridgeConfig, CloseFrame, KeepAlive,
    WebSocketError, WsByteStream,
};
...
// --- Control-frame surfacing + sending (BridgeConfig / WsControl) ----------
...
// --- accept_with(): the handler sees the full offer and picks one ---------
